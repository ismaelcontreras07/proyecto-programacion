...
const fragmentShader = `
  ...
  void main() {
    ...
    ditheredColor.r = floor(color.r * (levels - 1.0) + dither) / (levels - 1.0);
    ditheredColor.g = floor(color.g * (levels - 1.0) + dither) / (levels - 1.0);
    ditheredColor.b = floor(color.b * (levels - 1.0) + dither) / (levels - 1.0);
